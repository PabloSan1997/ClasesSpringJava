...
public class SpringSecurityConfig {
   ...
   @Bean
    SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        .requestMatchers(HttpMethod.GET,"/api/porducts").hasAnyRole("ADMIN", "USER")
        .requestMatchers(HttpMethod.POST,"/api/porducts").hasRole("ADMIN")
        .requestMatchers(HttpMethod.PUT,"/api/porducts/{id}").hasRole("ADMIN")
